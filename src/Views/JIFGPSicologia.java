...
private void tablaPsicologia() {
    try {
        GHistoria bdPsicologia = new GHistoria();
        ArrayList<Historia> arrPsicologia = bdPsicologia.listarPorEspecialidad(5); // ID de Psicología
        ...
        if (arrPsicologia != null && !arrPsicologia.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, 
                "No se encontraron registros de historias médicas para Psicología", 
...
private void cargarAreas() {
    try {
        ...
        ArrayList<Especialidad> lista = ge.listar();
