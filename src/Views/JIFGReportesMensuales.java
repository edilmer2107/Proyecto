...
public class JIFGReportesMensuales extends javax.swing.JInternalFrame {
    private static JIFGReportesMensuales instancia;
    
    public static JIFGReportesMensuales getInstancia() {
        if (instancia == null || instancia.isClosed()) {
            instancia = new JIFGReportesMensuales();
        }
        return instancia;
    }

    public JIFGReportesMensuales() {
        initComponents();
        generarEstadisticas();
    }
    ...
    private void generarEstadisticas() {
        try {
            ...
            for (Historia h : lista) {
                ...
                String mes = fecha.getMonth() + " " + fecha.getYear();
            ...
            sb.append("📆 Citas por MES:\n");
            porMes.forEach((k, v) -> sb.append("  ").append(k).append(": ").append(v).append("\n"));
